...
//creating a function call to convert array into a linked list with pointers next and next2
NodeAddress reverseLLWithNext2 (NodeAddress head) {
    int i;
    NodeAddress head;
    NodeAddress tail;
    NodeAddress pehlewala;
    NodeAddress pehlewala2;
    ...
    if (head->next != NULL && head->next2 != NULL)
    tail=head;
    pehlewala=head->next;
    pehlewala2=head->next2;
    tail->next=NULL;
    tail->next2=NULL;
    pehlewala->next=tail;
    pehlewala->next2=NULL;
    pehlewala2->next2=tail;
    pehlewala2->next=pehlewala;
    head=pehlewala;
